(function () {
  ...
  const plantTypes = [
    ...
    { emoji: "🥕", name: "Carrot", growthTime: 16, value: 15, cost: 10 },
    { emoji: "🥜", name: "Peanuts", growthTime: 16, value: 16, cost: 11 },
    { emoji: "🫘", name: "Beans", growthTime: 18, value: 16, cost: 12 },
    { emoji: "🥒", name: "Cucumber", growthTime: 18, value: 17, cost: 14 },
    { emoji: "🌶️", name: "Pepper", growthTime: 22, value: 20, cost: 15 },
    { emoji: "🫑", name: "Bell Pepper", growthTime: 23, value: 22, cost: 16 },
    { emoji: "🥔", name: "Potato", growthTime: 32, value: 30, cost: 20 },
    { emoji: "🍆", name: "Eggplant", growthTime: 30, value: 20, cost: 15 },
    { emoji: "🍅", name: "Tomato", growthTime: 30, value: 25, cost: 20 },
    { emoji: "🫛", name: "Peas", growthTime: 35, value: 20, cost: 15 },
    { emoji: "🥬", name: "Lettuce", growthTime: 38, value: 20, cost: 16 },
    { emoji: "🥦", name: "Broccoli", growthTime: 38, value: 25, cost: 18 },
    { emoji: "🌹", name: "Rose", growthTime: 40, value: 25, cost: 20 },
    { emoji: "🍎", name: "Apple", growthTime: 43, value: 25, cost: 20 },
    { emoji: "🍓", name: "Strawberry", growthTime: 46, value: 25, cost: 18 },
    { emoji: "🍐", name: "Pear", growthTime: 46, value: 25, cost: 20 },
    { emoji: "🍊", name: "Orange", growthTime: 48, value: 28, cost: 22 },
    { emoji: "🍋", name: "Lemon", growthTime: 48, value: 32, cost: 25 },
    { emoji: "🍋‍🟩", name: "Lime", growthTime: 48, value: 30, cost: 24 },
    { emoji: "🍌", name: "Banana", growthTime: 50, value: 38, cost: 30 },
    { emoji: "🍉", name: "Watermelon", growthTime: 50, value: 38, cost: 32 },
    { emoji: "🍍", name: "Pineapple", growthTime: 55, value: 45, cost: 35 },
    { emoji: "🫐", name: "Blueberries", growthTime: 55, value: 44, cost: 37 },
    { emoji: "🍈", name: "Melon", growthTime: 58, value: 48, cost: 40 },
    { emoji: "🍒", name: "Cherry", growthTime: 58, value: 45, cost: 38 },
    { emoji: "🍑", name: "Peach", growthTime: 60, value: 55, cost: 44 },
    { emoji: "🥭", name: "Mango", growthTime: 60, value: 50, cost: 42 },
    { emoji: "🍇", name: "Grapes", growthTime: 60, value: 50, cost: 45 },
    { emoji: "🥥", name: "Coconut", growthTime: 64, value: 52, cost: 46 },
    { emoji: "🥝", name: "Kiwi", growthTime: 64, value: 58, cost: 48 },
    { emoji: "🥑", name: "Avocado", growthTime: 68, value: 55, cost: 50 },
    { emoji: "🍄", name: "Mushroom", growthTime: 70, value: 62, cost: 55 },
    { emoji: "🌷", name: "Tulip", growthTime: 80, value: 61, cost: 55 },
    { emoji: "🪻", name: "Hyacinth", growthTime: 80, value: 63, cost: 58 },
    { emoji: "🪷", name: "Lotus", growthTime: 90, value: 66, cost: 60 },
    { emoji: "🌺", name: "Hibiscus", growthTime: 90, value: 68, cost: 62 },
    { emoji: "🌼", name: "Daisy", growthTime: 95, value: 70, cost: 65 },
    { emoji: "🌻", name: "Sunflower", growthTime: 100, value: 80, cost: 70 },
    { emoji: "🌸", name: "Sakura", growthTime: 120, value: 100, cost: 80 },
  ...
  function startFishingTensionLogic() {
    ...
    const loop = setInterval(() => {
      ...
      fishingCaughtFish.element.style.transform = `translate(-57%, -100%) rotate(${angle / Math.PI + 270}deg) scale(${fishingCaughtFish.weight})`;
