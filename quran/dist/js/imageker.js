...
function setSize(siz = "") {
    ...
    document.getElementById("txtarabic").style.fontSize = (parseInt(size) + 11) + "px";
}
...
function setBgColor() {
    let wrapimage = document.getElementById("wrapimage");
...
const checkfile = function (id = "") {
    ...
    if (me.files[0] != undefined) {
        ...
        if (allowext.indexOf(ext) > -1) {
            ...
            var gambar = document.getElementById('wrapimage');
